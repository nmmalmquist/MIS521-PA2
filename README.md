...
- CSS:
  ...
  - [C] Set the visibility of the 'searchResults' and 'time' divs to hidden.
  - [C] Style the rest of the page however you see fit. points will be lost if little or no effort is given in styling your site.
- JS:
